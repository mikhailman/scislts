package com.verishko.scislt.client;
...
public class Client {
    public static void main(String[] args) {
        final String sensorName = "ScSensor";
        ...
        for (int i = 0; i < 50; i++) {
            ...
            sendMeasurement(random.nextDouble() * 200 - 100, random.nextBoolean(), sensorName);
            try {
                Thread.sleep(random.nextInt(12000) + 3000);
